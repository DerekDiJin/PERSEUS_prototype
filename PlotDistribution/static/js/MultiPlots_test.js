...
svgMap["ev1ev2"] = drawPlot("#ev1ev2", "ev1ev2", false, false, true, "Eigenvalue 1", "Eigenvalue 2");
svgMap["ev2ev3"] = drawPlot("#ev2ev3", "ev2ev3", false, false, true, "Eigenvalue 2", "Eigenvalue 3");
...
function drawPlot(divId, fileName, xLog, yLog, heatMap, xLabelName, yLabelName){
    ...
    var tooltip = d3.select(divId).append("div")
        .attr("class", "tooltip")
        .style("opacity", 0);
    d3.text("/static/data/test/" + fileName, "text/csv", function(text) {
