...
var plotNames = ["degreeCount_HeatMap", "degreePagerank_HeatMap", "radiusCount_HeatMap", "degreeRadius_HeatMap", "ev1ev2_HeatMap", "ev2ev3_HeatMap"];
...
svgMap["radiusCount_HeatMap"] = drawPlot("#radiusCount", "radiusCount_HeatMap", false, true, false, "Radius", "log(Count)");
svgMap["degreeRadius_HeatMap"] = drawPlot("#degreeRadius", "degreeRadius_HeatMap", true, false, true, "log(Degree)", "Radius");
svgMap["ev1ev2_HeatMap"] = drawPlot("#ev1ev2", "ev1ev2_HeatMap", false, false, true, "Eigenvalue 1", "Eigenvalue 2");
svgMap["ev2ev3_HeatMap"] = drawPlot("#ev2ev3", "ev2ev3_HeatMap", false, false, true, "Eigenvalue 2", "Eigenvalue 3");
...
function clickShowAnomaly(gSize) {
  ...
  prevClickDotsSet = {};
  plotNames.forEach(function(pName){
    d3.text("/static/data/soc-Slashdot0811/" + gSize + "/" + pName + "_anomaly.txt", "text/csv", function(text) {
        var data = d3.tsv.parseRows(text);
